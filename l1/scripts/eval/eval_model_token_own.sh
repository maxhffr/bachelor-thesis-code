...
OUTPUT_DIR="$WORK/l1/artifacts/output/output_own"  # Add default output directory
...
for DATA_TYPE in "${DATATYPES[@]}"; do
    python3 -u main_generation.py \
        trainer.nnodes=1 \
        trainer.n_gpus_per_node=1 \
        data.path=$WORK/l1/artifacts/data_${NUM_TOKENS}/${DATA_TYPE}.parquet \
