...
DATATYPES=("aime" "math" "amc" "minerva" "olympiad_bench" "gpqa" "lsat" "mmlu_1000" "gsm8k_1000" "mgsm_de" "mgsm_fr" "mgsm_es" "mgsm_ru" "mgsm_zh" "mgsm_ja" "humaneval" "mgsm_de_lc" "mgsm_fr_lc" "mgsm_es_lc" "mgsm_ru_lc" "mgsm_zh_lc" "mgsm_ja_lc" "gsm8k" "mmlu")
...
for DATA_TYPE in "${DATATYPES[@]}"; do
    python3 main_generation.py \
        ...
        data.path=$WORK/l1/artifacts/data_3600/${DATA_TYPE}.parquet \
