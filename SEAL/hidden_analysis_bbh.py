...
def generate_eval_data(data_dir, data_path=None):
    correct, incorrect = [], []

    eval_path = os.path.join(data_dir, "bbh_eval.jsonl")
...
if __name__ == "__main__":
    ...
    correct, incorrect = generate_eval_data(data_dir=args.data_dir, data_path=args.data_path)
